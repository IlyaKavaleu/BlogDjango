...
urlpatterns = [
    ...
    path('sections/<int:section_id>/', cache_page(10)(views.section), name='section'),
    path('new_section/', views.new_section, name='new_section'),
    path('new_model/<int:section_id>/', views.new_model, name='new_model'),
    path('edit_section/<int:section_id>/', cache_page(10)(views.edit_section), name='edit_section'),
